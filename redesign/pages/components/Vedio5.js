            ...
            <section className="text-gray-600 body-font">
                <div data-aos="fade-down" className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div className=" lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-cyan-900"><span className="border-b-4 border-pink-400">From Micro To Large-Scale</span></h1>
