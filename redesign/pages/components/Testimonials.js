...
const Testimonials = () => {
    return (
        ...
        <div>
            <section>
                <div
                    data-aos="fade-down" className="px-4 py-16 mx-auto sm:px-6 lg:pl-8 lg:pr-0 lg:mr-0 sm:py-24 max-w-[1340px]"
                >
                    <div
                        className="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-16 gap-y-8 lg:items-center"
                    >
                        <div className="max-w-xl text-center sm:text-left">
                            <h2 className="text-3xl mt-auto font-bold tracking-tight sm:text-4xl">
                                What our customers are saying about
                            </h2>
                            <img alt='/' className='mt-6' src='/logo.svg'></img>
                                        ...
                                        >
                                            <div>
                                                ...
                                                <div data-aos="fade-left" className="mt-4">
                                                    ...
                                                    <p className="mt-4 font-bold leading-relaxed text-cyan-700">
