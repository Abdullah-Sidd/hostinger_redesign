...
const Pricingsection = () => {
    return (
        <div>
            <section data-aos="fade-down" className="py-10 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl"><span className="border-b-4 border-pink-400">Best Web Hosting  Plans</span></h2>
                    </div>
                    ...
                    <div className="grid max-w-3xl grid-cols-1 gap-6 mx-auto sm:grid-cols-2 mt-14 md:gap-9">
                        <div className="overflow-hidden bg-transparent border-2 border-gray-200 rounded-md">
                            <div className="p-6 md:py-8 md:px-9">
                                ...
                                <a
                                    title=""
                                    className="inline-flex cursor-pointer items-center justify-center w-full px-4 py-3 mt-6 font-semibold text-gray-900 transition-all duration-200 bg-transparent border-2 rounded-full border-fuchsia-600 hover:bg-fuchsia-600 hover:text-white focus:text-white focus:bg-fuchsia-600"
                                    role=""
                                >
                                ...
                                <ul className="flex flex-col mt-8 space-y-4">
                                    ...
                                    <li className="inline-flex items-center space-x-2">
                                        ...
                                        <span className="text-base font-medium text-gray-900"> Subdomains per account </span>
                                    </li>
                                    ...
                                    <li className="inline-flex items-center space-x-2">
                                        ...
                                        <span className="text-base font-medium text-gray-900"> Full acceleration  </span>
                                    </li>
                                    ...
                                    <li className="inline-flex items-center space-x-2">
                                        ...
                                        <strike className="text-base font-medium text-gray-400"> FAQ Database </strike>
                                    </li>
                                    ...
                                    <li className="inline-flex items-center space-x-2">
                                        ...
                                        <strike className="text-base font-medium text-gray-400"> Premium Support </strike>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white border-2 border-transparent rounded-md">
                            <div className="p-6 md:py-8 md:px-9">
                                <h3 className="text-xl font-semibold text-black">Buissnes</h3>
                                ...
                                <a  title="" className="inline-flex cursor-pointer items-center justify-center w-full px-4 py-3 mt-6 font-semibold text-white transition-all duration-200 border-2 border-transparent rounded-full bg-gradient-to-r from-fuchsia-600 to-blue-600 hover:opacity-80 focus:opacity-80" role="">
                                    Start 14 Days Free Trial
                                </a>
                                ...
                                <ul className="flex flex-col mt-8 space-y-4">
                                    ...
                                    <li className="inline-flex items-center space-x-2">
                                        ...
                                        <span className="text-base font-medium text-gray-900"> Huge acceleration  </span>
                                    </li>
                                    ...
                                    <li className="inline-flex items-center space-x-2">
                                        ...
                                        <span className="text-base font-medium text-gray-900">Automated Scaling suggestions </span>
                                    </li>
