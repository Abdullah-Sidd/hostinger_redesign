    ...
    return (
        <div>
            <section className="text-gray-600 body-font">
                <div data-aos="fade-down" className="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center">
                    <div className=" lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-cyan-900"><span className="border-b-4 border-pink-400">WordPress Made Easy</span></h1>
                        <p className="mb-8 leading-relaxed font-bold">Start your website with an automatic 1-click WordPress installation. The backend is powered by LiteSpeed caching and advanced optimization to ensure your websites are fast, reliable and secure.
                    ...
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                        ...
                        >
                            <source
                                src="https://assets.hostinger.com/videos/homepage2020/wordpress-made-easy-f182af6a28.mp4"
                            />
                        </video>
                    </div>
                </div>
